...
function transformNarrative(){
  const nav=[...document.querySelectorAll('[data-tab="reading"]')];
  nav.forEach(b=>{if(b.closest('nav')) b.textContent='Narrative';});
  const panel=document.querySelector('[data-panel="reading"]');
  if(!panel) return;
  panel.innerHTML=`<div class="wrap narrative-wrap">
    <div class="section-head narrative-head"><div><div class="eyebrow">06 · Narrative</div><h2>End in the narrative</h2></div><p>We begin with a standalone surviving text. We end by asking how that text sits within a wider cultural narrative — and how recovering that wider field changes what can be read.</p></div>
    <div class="narrative-thesis"><div class="eyebrow">The methodological movement</div><h3>A text is never entirely alone</h3><p>The words remain our fixed point, but words are encountered through places, institutions, objects, reputations, remembered events and cultural associations. The method does not replace close reading. It enlarges the field in which close reading can operate.</p></div>
    <div class="nested-narrative" aria-label="Text embedded within widening contextual layers">
      <div class="narrative-layer layer-cultural"><span>CULTURAL NARRATIVE</span>
        <div class="narrative-layer layer-memory"><span>COLLECTIVE MEMORY</span>
          <div class="narrative-layer layer-material"><span>MATERIAL ENVIRONMENT</span>
            <div class="narrative-layer layer-place"><span>PLACE &amp; INSTITUTION</span>
              <div class="narrative-core"><span>SURVIVING TEXT</span><strong>Euthyphro 2a–5a</strong><p>Socrates and Euthyphro meet at the Stoa Basileios; prosecution, piety and divine authority enter the conversation.</p></div>
            </div>
          </div>
        </div>
      </div>
    </div>
    <div class="narrative-caption"><strong>The text has not been altered.</strong><span>The field in which it can be read has widened.</span></div>
    <div class="reading-shifts">
      <article><div class="shift-label">Reading shift 01</div><h3>From location to institution</h3><div class="shift-pair"><p><strong>Text alone</strong><br>The Stoa Basileios is the named place of the encounter.</p><p><strong>Situated reading</strong><br>The named place also opens a recoverable institutional world in which legal and religious authority intersect. Euthyphro’s immediate recognition of Socrates’ situation can therefore be read against knowledge that Plato does not need to spell out within the dramatic exchange.</p></div></article>
      <article><div class="shift-label">Reading shift 02</div><h3>From absent object to cultural relationship</h3><div class="shift-pair"><p><strong>Text alone</strong><br>The herms do not appear in the surviving wording.</p><p><strong>Situated reading</strong><br>Archaeology restores them to the material environment; Thucydides restores a remembered civic narrative around them. The result is not a hidden meaning but a newly visible relationship between sacrilege, civic anxiety and a scene concerned with impiety and prosecution.</p></div></article>
      <article><div class="shift-label">Reading shift 03</div><h3>From reference to contextual question</h3><div class="shift-pair"><p><strong>Text alone</strong><br>At 5a Zeus enters Euthyphro’s argument as divine precedent.</p><p><strong>Situated reading</strong><br>The nearby Stoa of Zeus Eleutherios adds a spatial fact to the analytical field. That does not prove intention or salience; it gives us a relationship that can be tested alongside chronology, movement, institutional setting and reception.</p></div></article>
    </div>
    <div class="narrative-question"><div class="eyebrow">So how do we read the wider social context?</div><h3>By treating context as evidence that can be structured, mapped and compared</h3><p>The point is not to reconstruct a single ancient mind. It is to recover relationships that a modern text-only encounter tends to suppress: between words and places, places and institutions, objects and remembered events, people and reputations, and one dialogue and another. Those relationships can then be examined rather than merely imagined.</p></div>
